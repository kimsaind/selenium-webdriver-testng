...
public class Topic_04_Xpath_Css_Login {
 ...
 public void TC_04_Login_with_incorrect_Email_PW() {
	  ...
	  //Error email
	  Assert.assertEquals(driver.findElement(By.xpath("//ul[@class='messages']/li[@class='error-msg']")).getText(),"Invalid login or password.");
 ...
 public void TC_05_Create_New_Account() {
	  ...
	  Assert.assertEquals(driver.findElement(errorMessSecusses).getText(),"Thank you for registering with Main Website Store.");
